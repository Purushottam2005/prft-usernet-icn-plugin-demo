define([
	...
	"dojo/text!./templates/helloWorldFeature.html"
],
function(declare,
		_LaunchBarPane,
		template) {
	/**
	 * @name pluginDemonstrationDojo.helloWorldFeature
	 * @class 
	 * @augments ecm.widget.layout._LaunchBarPane
	 */
	return declare("pluginDemonstrationDojo.helloWorldFeature", [
		_LaunchBarPane
	], {
		/** @lends pluginDemonstrationDojo.helloWorldFeature.prototype */
